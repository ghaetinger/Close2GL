...
public:
  OptionWindow(Options *options, bool hasTex);
...
protected:
  ...
  // Setup Functions
  void setupWindowWidgets(bool hasTex);
  ...
  Gtk::CheckButton textureButton;
  void setTextureUse();

  Gtk::RadioButton nearestButton, bilinearButton, mipmapButton;
  void setNN();
  void setBilinear();
  void setMipMap();
  ...
  Gtk::Box mainBox, windBox, glBox, shaderBox, renderBox, camTypeBox, textureBox;
};
