...
bool Options::getShouldUseTexture() { return this->usesTexture; }
TextureMode Options::getTextureMode() { return this->texMode; }
...
void Options::setShouldUseTexture(bool should) { this->usesTexture = should; }
void Options::setTextureMode(TextureMode texMode) { this->texMode = texMode; }
