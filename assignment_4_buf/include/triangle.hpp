...
class Triangle {
public:
  Triangle(glm::vec3 vtxs[3], glm::vec3 normals[3], glm::vec2 texcoords[3]);
  ...
  void rasterize(float *colors, float *zbuffer, int width, int height,
                 ...
                 glm::mat4 MVP, glm::mat4 Viewport, bool useTex,
                 TextureMode texmode, uint8_t *image, int im_width,
                 int im_height, uint8_t **levels);
